      ...
      <div className="max-w-4xl mx-auto p-8 py-12">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            Vision Graphics is committed to ensuring that our website is
            accessible to everyone, regardless of their physical or cognitive
            ability. We strive to follow the Web Content Accessibility
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 mb-2">
            We welcome your feedback on the accessibility of the Vision
            Graphics website. If you encounter any accessibility barriers or
            have suggestions for improvement, please let us know:
          </p>
          <p className="text-gray-700 font-medium">Email: info@visiongraphics.com</p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-3">Contact Information</h2>
          <p className="text-gray-700">
            If you need assistance accessing any part of this website, please
            contact us and we will provide the information in an alternative
            format.
          </p>
        </section>
      </div>
