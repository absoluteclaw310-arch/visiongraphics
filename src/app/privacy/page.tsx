      ...
      <div className="max-w-4xl mx-auto p-8 py-12">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            Welcome to Vision Graphics. We are committed to protecting your
            personal information and your right to privacy. If you have any
            questions or concerns about our practices, please contact us.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            ...
            share information with trusted service providers (such as shipping
            carriers and payment processors) to the extent necessary to fulfill
            your orders.
          </p>
        </section>
